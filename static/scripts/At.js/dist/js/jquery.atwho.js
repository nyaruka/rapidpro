...
TextareaController = (function(superClass) {
  ...
  TextareaController.prototype.catchQuery = function() {
    ...
    query = this.callbacks("matcher").call(this, this.at, subtext, this.getOpt('escapeChar'), this.getOpt('startWithSpace'));
...
EditableController = (function(superClass) {
  ...
  EditableController.prototype.catchQuery = function(e) {
    ...
    matched = this.callbacks("matcher").call(this, this.at, _range.toString(), this.getOpt('escapeChar'), this.getOpt('startWithSpace'));
...
DEFAULT_CALLBACKS = {
  ...
  matcher: function(flag, subtext, escapeChar, should_startWithSpace, acceptSpaceBar) {
