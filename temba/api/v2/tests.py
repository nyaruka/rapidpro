...
class APITest(TembaTest):
    ...
    def test_api_groups_cant_delete_with_trigger_dependency(self):
        ...
        self.assertEqual(
            response.json(),
            {
                "detail": "This group is used by active triggers. In order to delete it, first remove triggers: block_group"
            },
        )
    ...
    def test_api_groups_cant_delete_with_flow_dependency(self):
        ...
        self.assertEqual(
            response.json(),
            {"detail": "This group is used by active flows. In order to delete it, first remove flows: Dependencies"},
        )
    ...
    def test_api_groups_cant_delete_with_campaign_dependency(self):
        ...
        self.assertEqual(
            response.json(),
            {
                "detail": "This group is used by active campaigns. In order to delete it, first remove campaigns: Don't forget to ..."
            },
        )
