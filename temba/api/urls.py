...
urlpatterns = patterns('api.views',
                       ...
                       url(
                           r'^/verboice/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           VerboiceHandler.as_view(),
                           name='api.verboice_handler'),
                       url(
                           r'^/africastalking/(?P<action>delivery|callback)/(?P<uuid>[a-z0-9\-]+)/$',
                           AfricasTalkingHandler.as_view(),
                           name='api.africas_talking_handler'),
                       url(
                           r'^/zenvia/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/$',
                           ZenviaHandler.as_view(),
                           name='api.zenvia_handler'),
                       url(
                           r'^/external/(?P<action>sent|delivered|failed|received)/(?P<uuid>[a-z0-9\-]+)/$',
                           ExternalHandler.as_view(),
                           name='api.external_handler'),
                       url(
                           r'^/shaqodoon/(?P<action>sent|delivered|failed|received)/(?P<uuid>[a-z0-9\-]+)/$',
                           ShaqodoonHandler.as_view(),
                           name='api.shaqodoon_handler'),
                       url(
                           r'^/nexmo/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/$',
                           NexmoHandler.as_view(),
                           name='api.nexmo_handler'),
                       url(
                           r'^/infobip/(?P<action>sent|delivered|failed|received)/(?P<uuid>[a-z0-9\-]+)/?$',
                           InfobipHandler.as_view(),
                           name='api.infobip_handler'),
                       url(
                           r'^/hub9/(?P<action>sent|delivered|failed|received)/(?P<uuid>[a-z0-9\-]+)/?$',
                           Hub9Handler.as_view(),
                           name='api.hub9_handler'),
                       url(
                           r'^/vumi/(?P<action>event|receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           VumiHandler.as_view(),
                           name='api.vumi_handler'),
                       url(
                           r'^/kannel/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           KannelHandler.as_view(),
                           name='api.kannel_handler'),
                       url(
                           r'^/clickatell/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           ClickatellHandler.as_view(),
                           name='api.clickatell_handler'),
                       url(
                           r'^/plivo/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           PlivoHandler.as_view(),
                           name='api.plivo_handler'),
                       url(
                           r'^/hcnx/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           HighConnectionHandler.as_view(),
                           name='api.hcnx_handler'),
                       url(
                           r'^/blackmyna/(?P<action>status|receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           BlackmynaHandler.as_view(),
                           name='api.blackmyna_handler'),
                       url(
                           r'^/smscentral/(?P<action>receive)/(?P<uuid>[a-z0-9\-]+)/?$',
                           SMSCentralHandler.as_view(),
                           name='api.smscentral_handler'),

                       url(r'^/mage/(?P<action>handle_message|follow_notification)$',
                           MageHandler.as_view(),
                           name='api.mage_handler'),
