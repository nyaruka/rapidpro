...
from .views import Home, MessageHistory, RangeDetails, WorkspaceStats, ChannelTypesStats
...
urlpatterns = [
    ...
    re_path(r"^dashboard/channel_types_stats/$", ChannelTypesStats.as_view(), {}, "dashboard.dashboard_channel_types_stats"),
