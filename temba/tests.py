...
class TembaMigrationTest(TembaTest):
    """
    From our friends at Caktus: https://www.caktusgroup.com/blog/2016/02/02/writing-unit-tests-django-migrations/
    """
    @property
    def app(self):
    ...
    def setUp(self):
        super(TembaMigrationTest, self).setUp()

        assert self.migrate_from and self.migrate_to, \
            "TestCase '{}' must define migrate_from and migrate_to properties".format(type(self).__name__)
        self.migrate_from = [(self.app[6:], self.migrate_from)]
        self.migrate_to = [(self.app[6:], self.migrate_to)]
