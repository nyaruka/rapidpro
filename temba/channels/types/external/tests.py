...
class ExternalTypeTest(TembaTest):
    def test_claim(self):
        ...
        self.assertEqual(post_data['url'], channel.config_json()[Channel.CONFIG_SEND_URL])
        self.assertEqual(post_data['method'], channel.config_json()[Channel.CONFIG_SEND_METHOD])
        self.assertEqual(post_data['content_type'], channel.config_json()[Channel.CONFIG_CONTENT_TYPE])
        self.assertEqual(channel.config_json()[Channel.CONFIG_MAX_LENGTH], 180)
