...
class WeChatType(ChannelType):
    ...
    claim_blurb = _("""Add a <a href="https://wechat.com">WeChat</a> bot to send and receive messages to WeChat users
    ...
    configuration_urls = (
        dict(
            label=_("Webhook URL"),
            url="https://{{ channel.callback_domain }}{% url 'courier.wc' channel.uuid %}",
        ),
        dict(
            label=_("Token"),
