...
# when mailroom started writing these events
# TODO remove when backfill completed
events_before = {
    "call_missed": datetime(2025, 8, 26, 20, 0, 0, 0, tzone.utc),
    "chat_started": datetime(2025, 8, 26, 20, 0, 0, 0, tzone.utc),
    "optin_started": datetime(2025, 8, 25, 20, 0, 0, 0, tzone.utc),
    "optin_stopped": datetime(2025, 8, 25, 20, 0, 0, 0, tzone.utc),
}
        ...
        try:
            with dynamo.HISTORY.batch_writer() as writer:
                for evt in batch:
                    ...
                    if evt.event_type == "mo_miss" and evt.created_on < events_before["call_missed"]:
                        data = {
                            "type": "call_missed",
                            "created_on": evt.created_on.isoformat(),
                            "channel": channel_ref,
                        }
                    elif evt.event_type == "new_conversation" and evt.created_on < events_before["chat_started"]:
                        data = {
                            "type": "chat_started",
                            "created_on": evt.created_on.isoformat(),
                            "channel": channel_ref,
                        }
                    elif evt.event_type == "referral" and evt.created_on < events_before["chat_started"]:
                        data = {
                            "type": "chat_started",
                            "created_on": evt.created_on.isoformat(),
                            "channel": channel_ref,
                    ...
                    elif evt.event_type == "optin" and evt.created_on < events_before["optin_started"]:
                        data = {
                            "type": "optin_started",
                            "created_on": evt.created_on.isoformat(),
                            "channel": channel_ref,
                    ...
                    elif evt.event_type == "optout" and evt.created_on < events_before["optin_stopped"]:
                        data = {
                            "type": "optin_stopped",
                            "created_on": evt.created_on.isoformat(),
                            "channel": channel_ref,
