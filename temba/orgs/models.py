...
class Org(SmartModel):
    ...
    def has_contacts(self):
        ...
        counts = ContactGroup.get_status_group_counts(self, (ContactGroup.TYPE_ACTIVE, ContactGroup.TYPE_BLOCKED))
    ...
    def active_contacts_group(self):
        ...
        return self.all_groups(manager="status_groups").get(group_type=ContactGroup.TYPE_ACTIVE)
