...
class ContactCRUDLTest(TembaTest):
    ...
    def test_list(self):
        ...
        self.set_field(self.joe, self.user, "age", "20")
        self.set_field(self.joe, self.user, "home", "Kigali")
        self.frank, urn_obj = Contact.get_or_create(self.org, "tel:124", user=self.user, name="Frank")
        self.set_field(self.frank, self.user, "age", "18")
...
class ContactGroupTest(TembaTest):
    ...
    def test_create_dynamic(self):
        ...
        self.set_field(self.joe, self.admin, "age", "17")
        self.set_field(self.joe, self.admin, "gender", "male")
        self.set_field(self.mary, self.admin, "age", "21")
        self.set_field(self.mary, self.admin, "gender", "female")
...
class ContactTest(TembaTest):
    ...
    def test_fail_and_block_and_release(self):
        ...
        self.set_field(self.joe, self.admin, "gender", "M")
    ...
    def test_user_groups(self):
        ...
        self.set_field(self.joe, self.admin, "gender", "M")
        self.set_field(self.joe, self.admin, "age", "28")
    ...
    def test_bulk_cache_initialize(self):
        ...
        self.set_field(self.joe, self.user, "age", "32")
        self.set_field(self.joe, self.user, "nick", "Joey")
        self.joe = Contact.objects.get(pk=self.joe.pk)
    ...
    def test_contact_search_evaluation(self):
        ...
        self.set_field(self.joe, self.admin, "age", "cedevita is not a number")
        self.assertFalse(evaluate_query(self.org, "age < 99", contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'age != ""', contact_json=self.joe.as_search_json()))
        self.assertTrue(evaluate_query(self.org, 'age = ""', contact_json=self.joe.as_search_json()))

        self.set_field(self.joe, self.admin, "age", "18")
        self.assertTrue(evaluate_query(self.org, 'age != ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'age = ""', contact_json=self.joe.as_search_json()))
        ...
        self.set_field(self.joe, self.admin, "joined", "cedevita is not a datetime object")
        self.assertFalse(evaluate_query(self.org, "joined < 01-04-2018", contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'joined != ""', contact_json=self.joe.as_search_json()))
        self.assertTrue(evaluate_query(self.org, 'joined = ""', contact_json=self.joe.as_search_json()))

        self.set_field(self.joe, self.admin, "joined", "01-03-2018")
        self.assertTrue(evaluate_query(self.org, 'joined != ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'joined = ""', contact_json=self.joe.as_search_json()))
        ...
        self.set_field(self.joe, self.admin, "ward", "cedevita is not a ward")
        self.assertFalse(evaluate_query(self.org, 'ward != ""', contact_json=self.joe.as_search_json()))
        self.assertTrue(evaluate_query(self.org, 'ward = ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'ward = "cedevita"', contact_json=self.joe.as_search_json()))

        self.set_field(self.joe, self.admin, "ward", "Rwanda > Eastern Province > Rwamagana > Bukure")
        self.assertTrue(evaluate_query(self.org, 'ward != ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'ward = ""', contact_json=self.joe.as_search_json()))
        ...
        self.set_field(self.joe, self.admin, "district", "cedevita is not a district")
        self.assertFalse(evaluate_query(self.org, 'district != ""', contact_json=self.joe.as_search_json()))
        self.assertTrue(evaluate_query(self.org, 'district = ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'district = "cedevita"', contact_json=self.joe.as_search_json()))

        self.set_field(self.joe, self.admin, "district", "Rwanda > Eastern Province > Rwamagana")
        self.assertTrue(evaluate_query(self.org, 'district != ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'district = ""', contact_json=self.joe.as_search_json()))
        ...
        self.set_field(self.joe, self.admin, "state", "cedevita is not a state")
        self.assertFalse(evaluate_query(self.org, 'state != ""', contact_json=self.joe.as_search_json()))
        self.assertTrue(evaluate_query(self.org, 'state = ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'state = "cedevita"', contact_json=self.joe.as_search_json()))

        self.set_field(self.joe, self.admin, "state", "Rwanda > Eastern Province")
        self.assertTrue(evaluate_query(self.org, 'state != ""', contact_json=self.joe.as_search_json()))
        self.assertFalse(evaluate_query(self.org, 'state = ""', contact_json=self.joe.as_search_json()))
        ...
        self.set_field(self.joe, self.admin, "gender", 'M"F')
    ...
    def test_contact_create_with_dynamicgroup_reevaluation(self):
        ...
        self.set_field(contact, self.user, "gender", "male")
        self.set_field(contact, self.user, "age", "20")
    ...
    def test_read(self):
        ...
        now = timezone.now()
        self.set_field(self.joe, self.user, "planting_date", (now + timedelta(days=1)).isoformat())
    ...
    def test_update_and_list(self, mock_mr):
        ...
        self.set_field(self.joe, self.user, "state", " kiGali   citY ")  # should match "Kigali City"
        ...
        self.set_field(self.joe, self.user, "state", "eastern province")
        ...
        state.save()
        self.set_field(self.joe, self.admin, "state", "Rwama Value")
    ...
    def test_contact_read_with_contactfields(self):
        ...
        self.set_field(self.joe, self.admin, "first", "a simple value")
        ...
        self.set_field(self.joe, self.admin, "third", "a simple value")
    ...
    def test_contact_model_update(self):
        ...
        with patch("temba.mailroom.client.MailroomClient") as mock_mr:
            ...
            self.joe.update(self.admin, "Joe Blow", "")
            self.assertFalse(instance.contact_modify.called)
    ...
    def test_contact_model(self):
        ...
        self.set_field(contact1, self.editor, "occupation", "Musician")
    ...
    def test_field_json(self):
        ...
        self.set_field(self.joe, self.user, "dog", "2300")
        self.joe.refresh_from_db()
        ...
        self.set_field(self.joe, self.user, "dog", "NaN")
        self.joe.refresh_from_db()
        self.assertEqual(self.joe.fields, {dog_uuid: {"text": "NaN"}})

        # datetime instead
        self.set_field(self.joe, self.user, "dog", "2018-03-05T02:31:00.000Z")
        self.joe.refresh_from_db()
        self.assertEqual(
        ...
        self.set_field(self.joe, self.user, "cat", "Rando", label="Cat")
        self.joe.refresh_from_db()
        ...
        self.set_field(self.joe, self.user, "cat", "Rwanda > Kigali City")
        self.joe.refresh_from_db()
        self.assertEqual(
            self.joe.fields,
            {
        ...
        self.set_field(self.joe, self.user, "cat", "")
        self.joe.refresh_from_db()
        ...
        self.set_field(self.joe, self.user, "state", "i live in eastern province")
        self.joe.refresh_from_db()
        self.assertEqual(
        ...
        self.set_field(self.joe, self.user, "district", "gatsibo")
        self.set_field(self.joe, self.user, "ward", "kageyo")
        self.joe.refresh_from_db()
    ...
    def test_fields(self):
        ...
        self.set_field(self.joe, self.user, "abc_1234", "Joe", label="First Name")
        self.assertEqual("Joe", self.joe.get_field_serialized(abc))
        ...
        with self.assertNumQueries(1):
            self.set_field(self.joe, self.user, "abc_1234", "Joe")
    ...
    def test_date_field(self):
        ...
        self.set_field(self.joe, self.user, "birth_date", urn)
    ...
    def test_field_values(self):
        ...
        self.set_field(joe, self.user, "registration_date", "2014-12-31T01:04:00Z")
        self.set_field(joe, self.user, "weight", "75.888888")
        self.set_field(joe, self.user, "color", "green")
        self.set_field(joe, self.user, "state", "kigali city")
        ...
        self.set_field(joe, self.user, "weight", "0")
        ...
        self.set_field(joe, self.user, "weight", "xxx")
        self.assertEqual(joe.get_field_serialized(weight_field), None)
        self.assertEqual(joe.get_field_display(weight_field), "")
    ...
    def test_set_location_fields(self):
        ...
        joe = Contact.objects.get(pk=self.joe.pk)
        self.set_field(joe, self.user, "district", "Remera")
        ...
        self.set_field(joe, self.user, "not_state", "kigali city")
    ...
    def test_set_location_ward_fields(self):
        ...
        self.set_field(jemila, user1, "state", "kano")
        self.set_field(jemila, user1, "district", "bichi")
        self.set_field(jemila, user1, "ward", "bichi")
    ...
    def test_update_handling(self):
        ...
        old_modified_on = bob.modified_on
        self.set_field(bob, self.user, "nickname", "Bobby")
        self.assertTrue(bob.modified_on > old_modified_on)
        ...
        with patch.object(timezone, "now", return_value=tz.localize(datetime(2014, 1, 2, 3, 4, 5, 6))):
            ...
            self.set_field(self.mary, self.user, "gender", "Female")
            self.set_field(self.mary, self.user, "age", "21")
            self.set_field(self.mary, self.user, "joined", "31/12/2013")
            self.annie = self.create_contact("Annie", "7879")
            self.set_field(self.annie, self.user, "gender", "Female")
            self.set_field(self.annie, self.user, "age", "9")
            self.set_field(self.annie, self.user, "joined", "31/12/2013")
            self.set_field(self.joe, self.user, "gender", "Male")
            self.set_field(self.joe, self.user, "age", "25")
            self.set_field(self.joe, self.user, "joined", "1/1/2014")
            self.set_field(self.frank, self.user, "gender", "Male")
            self.set_field(self.frank, self.user, "age", "50")
            self.set_field(self.frank, self.user, "joined", "1/1/2014")
            ...
            self.set_field(self.frank, self.user, "gender", "Female")
...
class ContactFieldTest(TembaTest):
    ...
    def test_contact_templatetag(self):
        self.set_field(self.joe, self.user, "First", "Starter")
    ...
    def test_contact_export(self):
        ...
        self.set_field(contact, self.user, "First", "On\02e")

        # make third a datetime
        self.contactfield_3.value_type = Value.TYPE_DATETIME
        self.contactfield_3.save()

        self.set_field(contact, self.user, "Third", "20/12/2015 08:30")
...
class ESIntegrationTest(TembaNonAtomicTest):
    def test_ES_contacts_index(self):
        ...
        for i in range(90):
            ...
            self.set_field(contact, self.admin, "age", str(i + 10))
            self.set_field(contact, self.admin, "join_date", str(join_date))
            self.set_field(contact, self.admin, "state", "Eastern Province")
            self.set_field(contact, self.admin, "home", districts[i % len(districts)])
            self.set_field(contact, self.admin, "ward", wards[i % len(wards)])

            self.set_field(contact, self.admin, "isureporter", "yes" if i % 2 == 0 else "no" if i % 3 == 0 else None)
            self.set_field(contact, self.admin, "hasbirth", "no")

            if i % 3 == 0:
                self.set_field(
                    contact, self.admin, "profession", "Farmer"
                )  # only some contacts have any value for this
