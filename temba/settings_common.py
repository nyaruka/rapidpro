...
GROUP_PERMISSIONS = {
    ...
    "Editors": (
        ...
        "tickets.article_create",
        "tickets.article_delete",
        "tickets.article_list",
        "tickets.article_read",
        "tickets.article_update",
        "tickets.knowledge_create",
        "tickets.knowledge_delete",
        "tickets.knowledge_menu",
        "tickets.knowledge_read",
        "tickets.knowledge_update",
        "tickets.knowledge_upload",
        "tickets.knowledgeitem_delete",
