...
class CampaignTest(TembaTest):
    ...
    def test_views(self):
        ...
        self.set_field(self.farmer2, self.user, "planting_date", "1/6/2022")
        ...
        self.set_field(self.nonfarmer, self.user, "planting_date", "1/7/2025")
    ...
    def test_eventfire_get_relative_to_value(self):
        ...
        self.set_field(self.farmer1, self.admin, "planting_date", self.org.format_datetime(timezone.now()))
    ...
    def test_campaignevent_calculate_scheduled_fire(self):
        ...
        self.set_field(self.farmer1, self.admin, "planting_date", self.org.format_datetime(planting_date))
    ...
    def test_deleting_reimport_contact_groups(self):
        ...
        self.set_field(self.farmer1, self.user, "planting_date", "10-05-2020 12:30:10")
        self.set_field(self.farmer2, self.user, "planting_date", "15-05-2020 12:30:10")
        ...
        self.set_field(self.farmer1, self.user, "planting_date", "13-08-2020 12:30:10")
        self.set_field(self.farmer2, self.user, "planting_date", "18-08-2020 12:30:10")
        ...
        self.set_field(self.nonfarmer, self.user, "planting_date", "20-05-2020 12:30:10")
    ...
    def test_dst_scheduling(self):
        ...
        self.set_field(self.farmer1, self.user, "planting_date", "03-11-2029 12:30:00")
        EventFire.update_campaign_events(campaign)
        ...
        self.set_field(self.farmer1, self.user, "planting_date", "10-03-2029 02:30:00")
        EventFire.update_campaign_events(campaign)
    ...
    def test_scheduling(self):
        ...
        self.set_field(self.farmer1, self.user, "planting_date", "05-10-2020 12:30:10")
        ...
        self.set_field(self.farmer1, self.user, "planting_date", "06-10-2020 12:30:10")
        ...
        self.set_field(self.farmer1, self.user, "planting_date", "what?")
        EventFire.update_campaign_events_for_contact(campaign, self.farmer1)
        self.assertFalse(EventFire.objects.all())

        # now something valid again
        self.set_field(self.farmer1, self.user, "planting_date", "07-10-2020 12:30:10")
        ...
        # update our date
        self.set_field(self.farmer1, self.user, "planting_date", "09-10-2020 12:30")
    ...
    def test_with_dynamic_group(self):
        ...
        self.set_field(anna, self.admin, "planting_date", "09-10-2020 12:30")
        ...
        self.set_field(anna, self.admin, "gender", "f")
