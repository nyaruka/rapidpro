...
class FlowBatchTest(FlowFileTest):
    ...
    def test_flow_batch_start(self):
        ...
        with QueryTracker(assert_query_count=248, stack_count=10, skip_unique_queries=True):
            flow.start([], contacts)
...
class QueryTest(FlowFileTest):
    ...
    def test_num_queries(self):
        ...
        with QueryTracker(assert_query_count=134, stack_count=10, skip_unique_queries=True):
            flow.start([], [self.contact])
