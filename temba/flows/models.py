...
from temba.utils import analytics, chunk_list, goflow, on_transaction_commit
...
class FlowRun(RequireUpdateFieldsMixin, models.Model):
    ...
    def add_messages(self, msgs, do_save=True):
        ...
        for msg in msgs:
            ...
            self.events.append(
                {
                    "type": goflow.Events.msg_received.name
                    if msg.direction == INCOMING
                    else goflow.Events.msg_created.name,
...
class FlowStep(models.Model):
    ...
    """
    STEP_TYPE_CHOICES = (("R", "RuleSet"), ("A", "ActionSet"))
    ...
    step_uuid = models.CharField(max_length=36, help_text=_("The UUID of the ActionSet or RuleSet for this step"))
    ...
    left_on = models.DateTimeField(null=True, help_text=_("When the user left this step in the flow"))
